...
union UNUMValue Add(union UNUMValue value1, union UNUMValue value2, enum NUMType type)
{
	...
	switch(type)
	{
	case INT: result.u_intValue = value1.u_intValue + value1.u_intValue; break;
	case FLOAT: result.u_floatValue = value1.u_floatValue + value1.u_floatValue; break;
	case DOUBLE: result.u_doubleValue = value1.u_doubleValue + value1.u_doubleValue; break;
}
return result;
}
